    ...
    return (
      <Container>
        ...
        >
          ...
          <p />
          <hr />
          <img className="pr-2 pb-2" src="./images/pay/master.png" />
          <img className="pr-2 pb-2" src="./images/pay/visa.png" />
          <img className="pr-2 pb-2" src="./images/pay/maestro.png" />
          <img className="pr-2 pb-2" src="./images/pay/uniteller.png" />
