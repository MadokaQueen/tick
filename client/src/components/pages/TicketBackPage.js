    ...
    return (
      <Container>
        ...
        <div className="container text-content inner-page wow fadeIn">
          ...
          <br />
          <p>
            Телефон для справок: <b>+7-495-127-71-19</b>
          </p>
          <br />
          ...
          <ul>
            ...
            <li>
              ...
              время возврата билетов), установленными согласно официальному
              письму организатора мероприятия, полученному от нас. С информацией
              о порядке, сроках и времени возврата билетов можно ознакомиться на
              сайте;
            </li>
            <li>
            ...
            <li>
              Вы можете получить деньги только по безналичному расчету, для
              этого вам необходимо сообщить нам подробные реквизиты.
            </li>
            <li>
